...
namespace Ai
{
    ...
    public class EnemyHandler
    {
        ...
        public List<FormStateMachine> AiFormStateMachine;
    
        public Rigidbody[] AIBodies { get; }

        [Inject]
        public EnemyHandler(EnemyAi[] enemyAis, List<FormStateMachine> aiFormStateMachine,
        ...
        public void RestartAllBots()
        {
            for (var i = 0; i < _aiNumber; i++)
            {
                ...
                AIBodies[i].position = _levelGenerator.AIStartPositions[i].position;
            }
        }
    }
}